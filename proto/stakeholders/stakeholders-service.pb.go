...
const file_stakeholders_stakeholders_service_proto_rawDesc = "" +
	"\n" +
	"'stakeholders/stakeholders-service.proto\x1a\x1cgoogle/api/annotations.proto\"w\n" +
	...
	"\vGetAllUsers\x12\x13.GetAllUsersRequest\x1a\x14.GetAllUsersResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/admin/users/all\x12V\n" +
	"\tBlockUser\x12\x11.BlockUserRequest\x1a\x12.BlockUserResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*2\x17/admin/users/block/{id}\x12^\n" +
	"\vUnblockUser\x12\x13.UnblockUserRequest\x1a\x14.UnblockUserResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*2\x19/admin/users/unblock/{id}\x12]\n" +
	"\x0eGetUserProfile\x12\x12.GetProfileRequest\x1a\x14.UserProfileResponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/users/profile/{username}\x12h\n" +
	"\x11UpdateUserProfile\x12\x15.UpdateProfileRequest\x1a\x16.UpdateProfileResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19/users/profile/{username}\x12u\n" +
	"\x12UploadProfileImage\x12\x1a.UploadProfileImageRequest\x1a\x1b.UploadProfileImageResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/users/profile/upload-imageB\x14Z\x12proto/stakeholdersb\x06proto3"
...
var file_stakeholders_stakeholders_service_proto_goTypes = []any{
	...
	(*UploadProfileImageResponse)(nil), // 14: UploadProfileImageResponse
	(*UploadProfileImageRequest)(nil),  // 15: UploadProfileImageRequest
}
var file_stakeholders_stakeholders_service_proto_depIdxs = []int32{
	...
	15, // 8: StakeholdersService.UploadProfileImage:input_type -> UploadProfileImageRequest
	...
	14, // 16: StakeholdersService.UploadProfileImage:output_type -> UploadProfileImageResponse
